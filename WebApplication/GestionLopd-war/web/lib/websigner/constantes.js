 ...
 *******************************************************************************/
var baseDownloadURL = "http://localhost:8080/GestionLopd/lib/websigner";

/*******************************************************************************
 * Ruta al directorio del instalador (Bootloader), los ficheros de			   *
 * configuración de JNLP y los nócleos del Cliente.							   *
 ...
 * Se debe usar siempre el separador "/", nunca "\".						   *
 *******************************************************************************/
var base = "http://localhost:8080/GestionLopd/lib/websigner";

/********************************************************************************
 * Algoritmo de firma. Puede ser 'SHA1withRSA', 'MD5withRSA' o, salvo que sea	*
 * firma XML, MD2withRSA. Tambión se puede utilizar un algoritmo SHA-2			*
 * ('SHA512withRSA', 'SHA384withRSA' o 'SHA256withRSA'), teniendo en cuenta que	*
 * el usuario sólo podró ejecutar esta firma si cuenta con Java 6u30 o superior *
 ...
 * Por defecto: CADES.										 *
 ******************************************************************************/
var signatureFormat = 'XMLDSIGN'; // Valor por defecto
 ...
 * inteligentes, sólo se mostrarón si estaban insertados en el momento de abrir*
