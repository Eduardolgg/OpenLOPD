...
/**
 * Controla la página tiposSoporte.jsp
 * 
 * @author Eduardo L. García Glez.
 * @version 0.0.0 30 de dic de 2012
 */
public class TiposSoporte extends AbstractWebPageController implements Serializable {

    public TiposSoporte() {
        super(ColumnasPermisos.TIPOS_DE_SOPORTES);
    }
