...
/**
 * Controla la página modosDestruccion.jsp
 *
 * @author Eduardo L. García Glez.
 * @version 0.0.0 30 de dic de 2012
 */
public class CModosDestruccion extends AbstractWebPageController implements Serializable {

    public CModosDestruccion() {
        super(ColumnasPermisos.MODOS_DESTRUCCION);
    }
}
