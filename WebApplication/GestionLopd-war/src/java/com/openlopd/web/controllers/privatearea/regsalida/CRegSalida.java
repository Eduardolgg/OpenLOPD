...
/**
 * Controla la página regsalida.jsp
 * 
 * @author Eduardo L. García Glez.
 * @version 0.0.0 30 de dic de 2012
 */
public class CRegSalida extends AbstractWebPageController implements Serializable {

    public CRegSalida() {
        super(ColumnasPermisos.REGISTRO_SALIDA);
    }
