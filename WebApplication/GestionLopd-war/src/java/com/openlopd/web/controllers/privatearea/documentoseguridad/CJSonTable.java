...
public class CJSonTable extends AbstractCDataTable implements Serializable {
    ...
    public String getJson() {
        List<DocumentoSeguridad> aTable = documentoSeguridadFacade.findAllFiltering(this, session.getAccessInfo());
        DTResponse<DocumentoSeguridad> dtResponse = new DTResponse<>(aTable.size(), aTable.size(),
