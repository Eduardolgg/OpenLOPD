...
/**
 * Controla la página personas.jsp
 *
 * @author Eduardo L. García Glez.
 * @version 0.0.0 30 de dic de 2012
 */
public class CPersonas extends AbstractWebPageController implements Serializable {

    public CPersonas() {
        super(ColumnasPermisos.GESTION_PERSONAL);
    }
}
