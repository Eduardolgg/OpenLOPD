...
/**
 * Controla la página regentrada.jsp
 * 
 * @author Eduardo L. García Glez.
 * @version 0.0.0 30 de dic de 2012
 */
public class CRegistroEntrada extends AbstractWebPageController implements Serializable {

    public CRegistroEntrada() {
        super(ColumnasPermisos.REGISTRO_ENTRADA);
    }
