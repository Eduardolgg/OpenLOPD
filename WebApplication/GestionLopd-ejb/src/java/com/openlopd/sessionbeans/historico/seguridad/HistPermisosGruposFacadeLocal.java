 ...
 */
@Local
public interface HistPermisosGruposFacadeLocal {

    void create(HistPermisosGrupos histPermisosGrupos);

    void edit(HistPermisosGrupos histPermisosGrupos);

    void remove(HistPermisosGrupos histPermisosGrupos);

    HistPermisosGrupos find(Object id);

    List<HistPermisosGrupos> findAll();

    List<HistPermisosGrupos> findRange(int[] range);
