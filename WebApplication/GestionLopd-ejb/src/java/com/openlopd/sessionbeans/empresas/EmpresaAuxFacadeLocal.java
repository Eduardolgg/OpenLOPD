 ...
 */
@Local
public interface EmpresaAuxFacadeLocal {

    void create(EmpresaAux empresaAux);

    void edit(EmpresaAux empresaAux);

    void remove(EmpresaAux empresaAux);

    EmpresaAux find(Object id);

    List<EmpresaAux> findAll();

    List<EmpresaAux> findRange(int[] range);
