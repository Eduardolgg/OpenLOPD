 ...
 */
@Stateless
public class EmpresaObservacionesFacade extends AbstractFacade<EmpresaObservaciones> implements EmpresaObservacionesFacadeLocal {
    ...
    public EmpresaObservacionesFacade() {
        super(EmpresaObservaciones.class);
    }
