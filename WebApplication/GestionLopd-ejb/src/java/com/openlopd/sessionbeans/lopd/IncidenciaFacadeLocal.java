...
public interface IncidenciaFacadeLocal {
    ...
    void create(AccessInfo accessInfo, Incidencia incidencia) 
            throws UnknownColumnException, SeguridadWriteException, 
            SeguridadWriteLimitException;

    void edit(AccessInfo accessInfo, Incidencia incidencia) 
            throws UnknownColumnException, SeguridadWriteException, 
            SeguridadWriteLimitException;

    void remove(AccessInfo accessInfo, Incidencia incidencia) 
            throws UnknownColumnException, SeguridadWriteException, 
            SeguridadWriteLimitException;
    ...
    public List<Incidencia> findAllFiltering(AbstractCDataTable a, AccessInfo accessInfo);
