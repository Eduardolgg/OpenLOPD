...
/**
 * Gestión de los modos de destrucción de soportes.
 * @author Eduardo L. García Glez.
 */
@Entity
@Table(name = "modo_destruccion", schema = "lopd")
@NamedQueries({
    @NamedQuery(name = "ModoDestruccion.findAll", query = ""
    + "SELECT m FROM ModoDestruccion m WHERE m.borrado is null AND m.empresa = :empresa")
})
public class ModoDestruccion implements Serializable, JsonEntity  {
    private static Logger logger = LoggerFactory.getLogger(ModoDestruccion.class);
    ...
    public ModoDestruccion() {
        this.borrado = null;
        this.borradoPor = null;
        this.active = true;
    }

    public ModoDestruccion(String id) {
        this.id = id;
        this.borrado = null;
        this.borradoPor = null;
        this.active = true;
    ...
    public ModoDestruccion(String id, String nombre, String descripcion, 
    ...
    public boolean equals(Object obj) {
        ...
        final ModoDestruccion other = (ModoDestruccion) obj;
    ...
    public JSONObject toTableEditableJson(ResponseConfig config) {
        ...
        try {
            js.put("4", "<a id=\"" + this.id 
                    + "\" class=\"table-action-EditData ui-icon ui-icon-pencil\">Edit</a>");
